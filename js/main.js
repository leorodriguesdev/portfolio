...
var experienceTitles = ['experiências', 'experiências', 'experiências'];
...
function changeExperienceTitle() {
    var jobTitleElement = document.getElementById('experience');
    var nextJobTitle = experienceTitles[currentJobTitleIndex];

    typeJobTitle(jobTitleElement, nextJobTitle, function() {
        setTimeout(function() {
            currentJobTitleIndex = (currentJobTitleIndex + 1) % experienceTitles.length;
            changeJobTitle();
        }, 3000);
    });
}
